...
def get_nin_search_space():
    ...
    params['weight_cost1']=Param('weight_cost1',numpy.log(10**(-5)),0.001,distrib='uniform',scale='log')
    params['weight_cost2']=Param('weight_cost2',numpy.log(10**(-5)),0.001,distrib='uniform',scale='log')
    params['weight_cost3']=Param('weight_cost3',numpy.log(10**(-5)),0.001,distrib='uniform',scale='log')
